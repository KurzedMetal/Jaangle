...
//DWORD WINAPI CRC32::CRC32ThreadProc(LPVOID lpVoid)
//{
...
void CRC32::Calculate(const LPBYTE buffer, UINT size, ULONG &CRC)
{   // calculate the CRC
    LPBYTE pbyte = buffer;
...
DWORD CRC32::CalcCRC(LPVOID buffer, UINT size)
